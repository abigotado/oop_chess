package org.abigotado.app.domain.models;

import org.abigotado.app.domain.models.pieces.ChessPiece;
import org.abigotado.app.domain.models.pieces.King;
import org.abigotado.app.domain.models.pieces.Rook;
...
public class ChessBoard {
    ...
    public void printBoard() {  //print board in console
        System.out.println("Turn " + nowPlayer); System.out.println(); System.out.println("Player 2(Black)");
        System.out.println(); System.out.println("\t0\t1\t2\t3\t4\t5\t6\t7");

        for (int i = 7; i > -1; i--) {
            System.out.print(i + "\t"); for (int j = 0; j < 8; j++) {
                if (board[i][j] == null) {
                    System.out.print(".." + "\t");
                }
                else {
